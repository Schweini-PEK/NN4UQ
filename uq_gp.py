...
dim_num_dense_nodes = Integer(low=20, high=40, name='num_nodes')
...
if __name__ == '__main__':
    ...
    print(gp_result)
    print('Best parameters: lr={}, bs={}, blocks={}, n_layers={}, n_nodes={}'
          .format(gp_result.x[0], gp_result.x[1], gp_result.x[2], gp_result.x[3], gp_result.x[4]))
